        ...
        <div class="menubar-scroll-inner">
            <ul class="app-menu">
                ...
                <li class="has-submenu">
                    ...
                    <ul class="submenu">
                        <li><a href="#"><span class="menu-text">Rəsim qalereyası</span></a></li>
                        <li><a href="#"><span class="menu-text">Video qalereyası</span></a></li>
                        <li><a href="#"><span class="menu-text">Fayl qalereyası</span></a></li>
                ...
                <li>
                    <a href="javascript:void(0)">
                        ...
                        <span class="menu-text">Slayd</span>
                    </a>
                </li>
                ...
                <li>
                    <a href="javascript:void(0)">
                        ...
                        <span class="menu-text">Dərslər</span>
                    </a>
                </li>
                ...
                <li>
                    <a href="javascript:void(0)">
                        ...
                        <span class="menu-text">Abunələr</span>
                    </a>
                </li>
                ...
                <li>
                    <a href="javascript:void(0)">
                        ...
                        <span class="menu-text">Popup xidməti</span>
                    </a>
                </li>
