<div class="row">
    <div class="col-md-12">
        <h4 class="m-b-lg">
            ...
            <a href="#" class="btn btn-outline btn-primary btn-xs pull-right"><i class="fa fa-plus"></i>Yeni əlavə et</a>
    ...
    <div class="col-md-12">
        <div class="widget p-lg">
            <div class="alert alert-info text-center">
                <p>Burada hər hansı bir məhsula ayıd qeydlər mövcud deyil ! Əlavə etmək üçün <a href="#">klik edin</a></p>
            </div>
               ...
               <thead>
                ...
                <tbody>
                    <tr>
                        ...
                        <td>monitor</td>
                        <td>Monitor</td>
                        <td>Full HD samsung monitoru</td>
                        <td>
